...
const ComboNorthPackage = () => {

  const destination = "Combo-North";
      ...
      <div className="bg-white p-4 mt-6 shadow-md rounded-lg">
        ...
        <div className="mt-4 p-4 border rounded-lg shadow">
          ...
          <div className="mb-4">
            ...
            <p className="mt-2 font-bold">Tsongmo</p>
            <ul className="list-disc pl-5 font-light">
              <li>Tsongmo Lake</li>
            </ul>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="mt-2 font-bold">Gangtok Sightseeing</p>
            <ul className="list-disc pl-5 font-light">
              <li>Overnight stay at Gangtok</li>
            </ul>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc pl-5 font-light">
                ...
                <li>Overnight stay at Lachen</li>
            </ul>
          </div>

          <div className="mb-4">
            <h3 className="text-lg font-bold bg-yellow-500 text-white inline-block px-3 py-1 rounded">DAY 6</h3>
            <p className="mt-2 font-bold">Lachen Sightseeing</p>
            <ul className="list-disc pl-5 font-light">
                <li>Gurudongmar Lake</li>
                <li>Back to Gangtok</li>
            </ul>
          </div>

          <div className="mb-4">
            <h3 className="text-lg font-bold bg-yellow-500 text-white inline-block px-3 py-1 rounded">DAY 7</h3>
...
export default ComboNorthPackage;
