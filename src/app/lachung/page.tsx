...
const LachungPackage = () => {

  const destination = "Lachung";
  ...
  return (
    <>
     ...
     <img src="./images/lachung.jpg" className="h-64 w-full object-cover rounded-lg mb-4"/>
      {/* Header Section */}
      <h1 className="text-xl font-bold text-red-600">
        GTK006 Lachung | 1 Night 2 Days
      </h1>
      ...
      <div className="bg-white p-4 mt-6 shadow-md rounded-lg">
        ...
        <div className="mt-4 p-4 border rounded-lg shadow">
          ...
          <div className="mb-4">
            ...
            <p className="mt-2 font-bold">Yumthang Valley and back to Gangtok</p>
