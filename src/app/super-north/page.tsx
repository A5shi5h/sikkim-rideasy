...
const SuperNorthPackage = () => {

  const destination = "Super-North";
  ...
  return (
    <>
     ...
     <img src="./images/north sikkim.jpg" className="h-64 w-full object-cover rounded-lg mb-4"/>
      {/* Header Section */}
      <h1 className="text-xl font-bold text-red-600">
        GTK008 Super-North | 4 Nights 5 Days
      </h1>
      ...
      <div className="bg-white p-4 mt-6 shadow-md rounded-lg">
        ...
        <div className="mt-4 p-4 border rounded-lg shadow">
          <div className="mb-4">
            ...
            <p className="mt-2"><strong>NJP / Bagdogra to Gangtok</strong></p>
          ...
          <div className="mb-4">
            ...
            <p className="mt-2 font-bold">Gangtok to Lachung</p>
            <ul className="list-disc pl-5 font-light">
              <li>Overnight stay at Lachung</li>
            </ul>
          </div>

          <div className="mb-4">
            <h3 className="text-lg font-bold bg-yellow-500 text-white inline-block px-3 py-1 rounded">DAY 3</h3>
            <p className="mt-2 font-bold">Lachung to Yumthang Valley</p>
            <ul className="list-disc pl-5 font-light">
              <li>Yumthang Valley</li>
            </ul>
            <p className="text-md font-light">Drop to Lachen</p>
          </div>

          <div className="mb-4">
            <h3 className="text-lg font-bold bg-yellow-500 text-white inline-block px-3 py-1 rounded">DAY 4</h3>
            <p className="mt-2 font-bold">Lachen to Gurudongmar</p>
            <ul className="list-disc pl-5 font-light">
              <li>Gurudongmar Lake</li>
            </ul>
            <p className="text-md font-light">Back to Gangtok</p>
          </div>

          <div className="mb-4">
            <h3 className="text-lg font-bold bg-yellow-500 text-white inline-block px-3 py-1 rounded">DAY 5</h3>
            <p className="mt-2 font-bold">Drop to Bagdogra , NJP/Siliguri , Darjeeling</p>
            <ul className="list-disc pl-5 font-light">
              <li>End of tour</li>
            </ul>
          </div>
...
export default SuperNorthPackage;
